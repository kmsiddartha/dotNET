...
describe('useTokenBalance', () => {
    ...
    it('multichain calls return correct initial balances', async () => {
        ...
        await testMultiChainUseTokenBalance(secondDeployer.address, secondToken.address, SECOND_TEST_CHAIN_ID, SECOND_MOCK_TOKEN_INITIAL_BALANCE);
    });
    const testMultiChainUseTokenBalance = async (user, tokenAddress, chainId, initialBalance) => {
