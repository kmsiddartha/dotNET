...
describe('useTokenBalance', function () {
    ...
    it('returns balance', function () { return __awaiter(void 0, void 0, void 0, function () {
        var _a, result, waitForCurrent;
        return __generator(this, function (_b) {
            switch (_b.label) {
                case 0: return [4 /*yield*/, (0, testing_1.renderWeb3Hook)(function () { return (0, useTokenBalance_1.useTokenBalance)(token.address, deployer.address); }, {
    ...
    it('multichain calls return correct initial balances', function () { return __awaiter(void 0, void 0, void 0, function () {
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, testMultiChainUseTokenBalance(deployer.address, token.address, chainId_1.ChainId.Localhost, testing_1.MOCK_TOKEN_INITIAL_BALANCE)];
                case 1:
                    _a.sent();
                    return [4 /*yield*/, testMultiChainUseTokenBalance(secondDeployer.address, secondToken.address, testing_1.SECOND_TEST_CHAIN_ID, testing_1.SECOND_MOCK_TOKEN_INITIAL_BALANCE)];
                case 2:
                    _a.sent();
                    return [2 /*return*/];
            }
    ...
    var testMultiChainUseTokenBalance = function (user, tokenAddress, chainId, initialBalance) { return __awaiter(void 0, void 0, void 0, function () {
        var _a, result, waitForCurrent;
        var _b;
        return __generator(this, function (_c) {
            switch (_c.label) {
                case 0: return [4 /*yield*/, (0, testing_1.renderWeb3Hook)(function () { return (0, useTokenBalance_1.useTokenBalance)(tokenAddress, user, { chainId: chainId }); }, {
                        mockProvider: (_b = {},
                ...
                case 2:
                    _c.sent();
                    (0, chai_1.expect)(result.error).to.be.undefined;
                    (0, chai_1.expect)(result.current).to.eq(initialBalance);
                    return [2 /*return*/];
            }
        });
    }); };
