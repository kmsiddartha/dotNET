...
describe('useRawCall', function () {
    ...
    it('multichain calls return correct initial balances', function () { return __awaiter(void 0, void 0, void 0, function () {
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, testMultiChainUseRawCall(token, [deployer.address], chainId_1.ChainId.Localhost, testing_1.MOCK_TOKEN_INITIAL_BALANCE)];
                case 1:
                    _a.sent();
                    return [4 /*yield*/, testMultiChainUseRawCall(secondToken, [secondDeployer.address], testing_1.SECOND_TEST_CHAIN_ID, testing_1.SECOND_MOCK_TOKEN_INITIAL_BALANCE)];
                case 2:
                    _a.sent();
                    return [2 /*return*/];
            }
    ...
    var testMultiChainUseRawCall = function (contract, args, chainId, endValue) { return __awaiter(void 0, void 0, void 0, function () {
        ...
        return __generator(this, function (_c) {
            switch (_c.label) {
                ...
                case 2:
                    ...
                    (0, chai_1.expect)(result.error).to.be.undefined;
                    (0, chai_1.expect)(result.current.success).to.eq(true);
                    (0, chai_1.expect)(result.current.value).to.eq(endValue);
                    return [2 /*return*/];
            }
        });
    }); };
